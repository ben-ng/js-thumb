  ...
  var JSThumb = function() {
    ...
    */
    this.loadVideo = function (opts, cb) {
      ...
      //Video.js is a hard dependency
      _videoJs = videojs || vjs || _V_;
      ...
      opts.attributes = extend({}, opts.attributes, defaultAttributes);
      ...
      */
      ...
      afterVideoLoad = function(e) {
        ...
        if(expect<=0) {
          ...
          _videoJs(opts.attributes.id).width(videoDims.width).height(videoDims.height);
        }
      };
      ...
      videoElement.on('loadedmetadata', afterVideoLoad);
    };
    ...
    */
    this.resizeData(imageData, opts, cb) {
      opts = opts || {};
